  ...
  return (
    <div className="relative h-screen w-full overflow-hidden bg-apple-base text-white flex flex-col justify-between select-none">
      ...
      <main className="relative z-10 flex flex-col items-center justify-center px-4 w-full max-w-[420px] mx-auto">
        ...
        {/* LOGO AREA - Tight margin-bottom to bring everything closer */}
        <div className="flex flex-col items-center mb-4 fade-in">
          <img
            src="picture1.png"
            alt="SCREEN Logo"
            className="w-36 h-36 sm:w-48 sm:h-48 object-contain drop-shadow-[0_4px_16px_rgba(0,0,0,0.5)] mb-1"
          />
          <h1 className="text-[22px] font-semibold tracking-[-0.02em] text-white">
            SCREEN Research Portal
          </h1>
          <p className="text-[13px] text-white/70 text-center mt-0.5">
        ...
        <div 
          className={`w-full bg-apple-surface border ${error ? 'border-red-500/50' : 'border-apple-border'} hover:border-white/[0.04] rounded-14 p-6 shadow-[0_12px_36px_rgba(0,0,0,0.5)] transition-all duration-300 fade-in-delayed`}
        >
